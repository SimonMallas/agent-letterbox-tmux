...
See [SPEC.md](SPEC.md) for the protocol rules, [ROADMAP.md](ROADMAP.md) for supported v0.1 scope, and [docs/cmux.md](docs/cmux.md) for cross-workspace cmux operation and update verification. This repository contains no server, database, cloud service, agent-vendor dependency, or mandatory terminal multiplexer.
